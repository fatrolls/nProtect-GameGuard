...
// void __usercall _L63152(int a1@<ebp>);
...
// void __usercall _L63387(int a1@<ebp>);
...
// void __usercall _L63596(int a1@<ebp>);
...
char `string' = '\x01'; // idb
char `string' = '\x01'; // idb
_SCOPETABLE_ENTRY _T63637 = { -1, &_L63626, &_L63627 }; // weak
char `string' = '\x01'; // idb
char `string' = '\x01'; // idb
char `string'[14] =
{
...
DWORD __thiscall CGameGuard::PreInitNPGameMonI(CGameGuard *this, const char *Source)
{
  ...
  void *v42; // esi
  DWORD v43; // eax
  HANDLE (__stdcall *v44)(LPSECURITY_ATTRIBUTES, BOOL, BOOL, LPCSTR); // esi
  HANDLE v45; // eax
  DWORD (__stdcall *v46)(); // esi
  const char *v47; // eax
  HANDLE v48; // eax
  DWORD (__stdcall *v49)(); // esi
  HANDLE v50; // eax
  DWORD (__stdcall *v51)(); // esi
  const char *v52; // eax
  const char *v53; // eax
  bool v54; // al
  void (__stdcall *v55)(); // esi
  int v56; // eax
  int v57; // edi
  const char *v58; // eax
  HANDLE v59; // eax
  ...
  const char *v77; // eax
  const char *v78; // eax
  void (__stdcall *v79)(HANDLE); // esi
  const char *v80; // eax
  int v81; // eax
  void (__stdcall *v82)(HANDLE); // esi
  DWORD (__stdcall *v83)(); // esi
  DWORD v84; // ebx
  const char *v85; // eax
  char *v86; // eax
  DWORD (__stdcall *v87)(); // esi
  int v88; // ebx
  const char *v89; // eax
  const char *v90; // esi
  const char *v91; // eax
  ...
  HANDLE v121; // eax
  void *v122; // esi
  unsigned int v123; // kr48_4
  int v124; // ecx
  DWORD (__stdcall *v125)(); // esi
  const char *v126; // eax
  DWORD (__stdcall *v127)(); // esi
  const char *v128; // eax
  const char *v129; // eax
  unsigned int v130; // eax
  DWORD (__stdcall *v131)(); // esi
  const char *v132; // eax
  const char *v133; // eax
  const CHAR *v134; // eax
  HANDLE v135; // eax
  ...
  const char *v149; // eax
  const char *v150; // eax
  int v151; // [esp+0h] [ebp-1110h]
  int v152; // [esp+4h] [ebp-110Ch]
  int v153; // [esp+4h] [ebp-110Ch]
  int v154; // [esp+4h] [ebp-110Ch]
  int v155; // [esp+8h] [ebp-1108h]
  int v156; // [esp+8h] [ebp-1108h]
  unsigned int v157; // [esp+8h] [ebp-1108h]
  void *v158; // [esp+8h] [ebp-1108h]
  int v159; // [esp+Ch] [ebp-1104h]
  HANDLE v160; // [esp+Ch] [ebp-1104h]
  int v161; // [esp+Ch] [ebp-1104h]
  HANDLE v162; // [esp+Ch] [ebp-1104h]
  int v163; // [esp+Ch] [ebp-1104h]
  int v164; // [esp+Ch] [ebp-1104h]
  void *v165; // [esp+Ch] [ebp-1104h]
  int v166; // [esp+10h] [ebp-1100h]
  int v167; // [esp+10h] [ebp-1100h]
  int v168; // [esp+10h] [ebp-1100h]
  const char *v169; // [esp+10h] [ebp-1100h]
  int v170; // [esp+10h] [ebp-1100h]
  int v171; // [esp+10h] [ebp-1100h]
  int v172; // [esp+14h] [ebp-10FCh]
  int v173; // [esp+14h] [ebp-10FCh]
  int v174; // [esp+14h] [ebp-10FCh]
  int v175; // [esp+14h] [ebp-10FCh]
  char *v176; // [esp+14h] [ebp-10FCh]
  int v177; // [esp+14h] [ebp-10FCh]
  int v178; // [esp+14h] [ebp-10FCh]
  int v179; // [esp+14h] [ebp-10FCh]
  int v180; // [esp+18h] [ebp-10F8h]
  int v181; // [esp+18h] [ebp-10F8h]
  DWORD v182; // [esp+18h] [ebp-10F8h]
  DWORD v183; // [esp+18h] [ebp-10F8h]
  int v184; // [esp+18h] [ebp-10F8h]
  char *v185; // [esp+18h] [ebp-10F8h]
  DWORD v186; // [esp+18h] [ebp-10F8h]
  int v187; // [esp+18h] [ebp-10F8h]
  int v188; // [esp+18h] [ebp-10F8h]
  DWORD v189; // [esp+18h] [ebp-10F8h]
  int v190; // [esp+18h] [ebp-10F8h]
  DWORD v191; // [esp+1Ch] [ebp-10F4h]
  int v192; // [esp+1Ch] [ebp-10F4h]
  DWORD v193; // [esp+1Ch] [ebp-10F4h]
  int v194; // [esp+1Ch] [ebp-10F4h]
  DWORD v195; // [esp+1Ch] [ebp-10F4h]
  DWORD v196; // [esp+1Ch] [ebp-10F4h]
  DWORD v197; // [esp+1Ch] [ebp-10F4h]
  int v198; // [esp+1Ch] [ebp-10F4h]
  DWORD v199; // [esp+1Ch] [ebp-10F4h]
  DWORD v200; // [esp+1Ch] [ebp-10F4h]
  DWORD v201; // [esp+1Ch] [ebp-10F4h]
  DWORD v202; // [esp+1Ch] [ebp-10F4h]
  int v203; // [esp+1Ch] [ebp-10F4h]
  int v204; // [esp+1Ch] [ebp-10F4h]
  DWORD v205; // [esp+1Ch] [ebp-10F4h]
  DWORD v206; // [esp+1Ch] [ebp-10F4h]
  DWORD v207; // [esp+1Ch] [ebp-10F4h]
  unsigned int v208; // [esp+1Ch] [ebp-10F4h]
  DWORD v209; // [esp+1Ch] [ebp-10F4h]
  DWORD Buffer; // [esp+30h] [ebp-10E0h] BYREF
  int v211; // [esp+34h] [ebp-10DCh]
  DWORD NumberOfBytesWritten; // [esp+38h] [ebp-10D8h] BYREF
  int v213; // [esp+3Ch] [ebp-10D4h]
  unsigned int v214; // [esp+40h] [ebp-10D0h]
  struct _PROCESS_INFORMATION ProcessInformation; // [esp+44h] [ebp-10CCh] BYREF
  DWORD ExitCode; // [esp+54h] [ebp-10BCh] BYREF
  DWORD NumberOfBytesRead[2]; // [esp+58h] [ebp-10B8h] BYREF
  int v218; // [esp+60h] [ebp-10B0h]
  int v219; // [esp+64h] [ebp-10ACh]
  int v220; // [esp+68h] [ebp-10A8h]
  int v221; // [esp+6Ch] [ebp-10A4h]
  int v222; // [esp+70h] [ebp-10A0h]
  int v223; // [esp+74h] [ebp-109Ch]
  int v224; // [esp+78h] [ebp-1098h]
  int v225; // [esp+7Ch] [ebp-1094h]
  int v226; // [esp+80h] [ebp-1090h]
  int v227; // [esp+84h] [ebp-108Ch]
  struct _SECURITY_ATTRIBUTES EventAttributes; // [esp+88h] [ebp-1088h] BYREF
  HANDLE Handles[2]; // [esp+94h] [ebp-107Ch] BYREF
  struct _STARTUPINFOA StartupInfo; // [esp+9Ch] [ebp-1074h] BYREF
  unsigned __int8 Str1[4]; // [esp+E0h] [ebp-1030h] BYREF
  int Filename[3]; // [esp+100h] [ebp-1010h] BYREF
  char v233[252]; // [esp+10Ch] [ebp-1004h] BYREF
  char FileName[260]; // [esp+208h] [ebp-F08h] BYREF
  CHAR v235[256]; // [esp+30Ch] [ebp-E04h] BYREF
  CHAR v236[260]; // [esp+40Ch] [ebp-D04h] BYREF
  CHAR CommandLine[1024]; // [esp+510h] [ebp-C00h] BYREF
  char v238[2048]; // [esp+910h] [ebp-800h] BYREF
  ...
  *((_BYTE *)this + 4639) = 0;
  ...
  if ( _access(&szLogFile, 0) == -1 && !CreateDirectoryA(&szLogFile, 0) )
  {
    ...
    v191 = v3();
    v4 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v4, v191);
    return 111;
  }
  ...
  *((_DWORD *)this + 1045) = 1000;
  ...
  v12 = CreateFileA((LPCSTR)Filename, 0xC0000000, 1u, 0, 2u, 0x80000080, 0);
  *v9 = v12;
  if ( v12 == (HANDLE)-1 )
  {
LABEL_22:
    v22 = _mbsrchr((const unsigned __int8 *)&szLogFile, 0x2Eu);
    v214 = (unsigned int)v22;
    if ( v22 )
    {
      v23 = 1;
      v218 = -973999051;
      ...
      while ( 1 )
      {
        v193 = v23;
        v24 = _Dect1(&`string');
        sprintf((char *const)v22, v24, v193);
        if ( *v9 == (HANDLE)-1 )
        {
          *((_DWORD *)this + 1044) = 0;
          *((_DWORD *)this + 1045) = 1000;
          ...
          v27 = CreateFileA((LPCSTR)Filename, 0xC0000000, 1u, 0, 2u, 0x80000080, 0);
          *v9 = v27;
          if ( v27 != (HANDLE)-1 )
            break;
        }
        ...
        if ( (int)Buffer >= 10 )
          goto LABEL_43;
        v22 = (unsigned __int8 *)v214;
      }
      GetLocalTime((LPSYSTEMTIME)((char *)this + 4156));
      v194 = *((unsigned __int16 *)this + 2085);
      v181 = *((unsigned __int16 *)this + 2084);
      v173 = *((unsigned __int16 *)this + 2083);
      v167 = *((unsigned __int16 *)this + 2082);
      v161 = *((unsigned __int16 *)this + 2081);
      v156 = *((unsigned __int16 *)this + 2079);
      v153 = *((unsigned __int16 *)this + 2078);
      v28 = _Dect(&`string');
      sprintf((char *const)this + 60, v28, v153, v156, v161, v167, v173, v181, v194);
      ...
      else
      {
        ...
        v214 = (v33 | 0x2C000000ui64) % 0xA;
        v162 = *v9;
        *((_DWORD *)this + 1043) = v33 | 0x2C000000 | ((v214 ^ 0x55) << 16);
        WriteFile(v162, (char *)this + 4172, 4u, &NumberOfBytesWritten, 0);
        *((_DWORD *)this + 1043) = *(&v218 + v214);
        if ( v29 > 0 )
        {
          v35 = (char *)this + 60;
          do
  ...
  {
    GetLocalTime((LPSYSTEMTIME)((char *)this + 4156));
    v192 = *((unsigned __int16 *)this + 2085);
    v180 = *((unsigned __int16 *)this + 2084);
    v172 = *((unsigned __int16 *)this + 2083);
    v166 = *((unsigned __int16 *)this + 2082);
    v159 = *((unsigned __int16 *)this + 2081);
    v155 = *((unsigned __int16 *)this + 2079);
    v152 = *((unsigned __int16 *)this + 2078);
    v13 = _Dect(&`string');
    sprintf((char *const)this + 60, v13, v152, v155, v159, v166, v172, v180, v192);
    ...
    else
    {
      ...
      v214 = (v18 | 0x2C000000ui64) % 0xA;
      v160 = *v9;
      *((_DWORD *)this + 1043) = v18 | 0x2C000000 | ((v214 ^ 0x55) << 16);
      WriteFile(v160, (char *)this + 4172, 4u, &NumberOfBytesWritten, 0);
      *((_DWORD *)this + 1043) = *(&v218 + v214);
      if ( v14 > 0 )
      {
        v20 = (char *)this + 60;
...
LABEL_43:
  v37 = _Dect(&`string');
  CLog::Write((CGameGuard *)((char *)this + 32), v37, 47, "Wed May  3 14:10:06 2006");
  v174 = *((_DWORD *)this + 1151);
  v38 = _Dect1(&`string');
  CLog::Write((CGameGuard *)((char *)this + 32), v38, v174, Source, InitNPGameMon);
  ...
  if ( !CGameGuard::CheckGameMonSingleInstance(this, 0) )
  {
    ++dwDE;
    v40 = _Dect1(&`string');
    v41 = OpenEventA(0x100000u, 0, v40);
    v42 = v41;
    if ( v41 )
    {
  ...
  v45 = CreateEventA(&EventAttributes, 0, 0, 0);
  *((_DWORD *)this + 1182) = v45;
  if ( !v45 )
  {
    v46 = GetLastError;
    GetLastError();
    ...
    v47 = _Dect1(`string');
LABEL_60:
    CLog::Write((CGameGuard *)((char *)this + 32), v47, v195);
    return 171;
  }
  v48 = v44(&EventAttributes, 1, 0, 0);
  *((_DWORD *)this + 6) = v48;
  if ( !v48 )
  {
    v49 = GetLastError;
  ...
  v50 = v44(&EventAttributes, 0, 0, 0);
  *((_DWORD *)this + 1181) = v50;
  if ( !v50 )
  {
    v51 = GetLastError;
    GetLastError();
  ...
  v52 = _Dect1(&`string');
  CLog::Write((CGameGuard *)((char *)this + 32), v52);
  ...
  {
    v53 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v53, FileName);
    return 153;
  }
  HIBYTE(v213) = 0;
  v54 = CFileAuthClient::Auth((CGameGuard *)((char *)this + 4532), FileName, 1);
  v55 = (void (__stdcall *)())GetLastError;
  if ( !v54 )
  {
    v56 = *((_DWORD *)this + 1150);
    HIBYTE(v211) = 0;
    if ( v56 == 8 && GetLastError() == -2146893818 )
      HIBYTE(v211) = 1;
    v55();
    v57 = *((_DWORD *)this + 1150);
    v182 = ((DWORD (__stdcall *)())v55)();
    v58 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v58, v57, v182, FileName);
    v59 = CreateFileA(FileName, 0x80000000, 3u, 0, 3u, 0x80u, 0);
    v60 = v59;
    if ( v59 == (HANDLE)-1 )
    {
      v183 = ((DWORD (__stdcall *)())v55)();
      v61 = _Dect1(&`string');
      CLog::Write((CGameGuard *)((char *)this + 32), v61, v183, FileName);
    }
    else
    {
      v196 = GetFileSize(v59, 0);
      v62 = _Dect1(&`string');
      CLog::Write((CGameGuard *)((char *)this + 32), v62, v196);
      SetFilePointer(v60, -4, 0, 2u);
      Buffer = 0;
      ReadFile(v60, &Buffer, 4u, NumberOfBytesRead, 0);
      v197 = Buffer;
      v63 = _Dect1(&`string');
      CLog::Write((CGameGuard *)((char *)this + 32), v63, v197);
      CloseHandle(v60);
    }
    if ( !HIBYTE(v211) )
      goto LABEL_79;
    ...
    {
      if ( *((_DWORD *)this + 1150) == 8 && ((DWORD (__stdcall *)())v55)() == -2146893818 )
        return 155;
      HIBYTE(v213) = 1;
    }
    v64 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v64);
    if ( HIBYTE(v213) )
    {
LABEL_79:
      v65 = _Dect1(&`string');
  ...
  v67 = *((_DWORD *)this + 1151);
  ProcessInformation.hProcess = 0;
  ProcessInformation.hThread = 0;
  StartupInfo.cb = 68;
  ProcessInformation.dwProcessId = 0;
  v198 = dwDE;
  v68 = *((_DWORD *)this + 1182);
  ...
  v157 = v214;
  v69 = _Dect1(&`string');
  _wsprintfA(v235, v69, v157, (char *)this + 4608, v168, v175, v184, v198);
  CLog::Write((CGameGuard *)((char *)this + 32), "cmd: %s", v235);
  Buffer = (DWORD)_Enct(v235);
  v70 = CommandLine;
  v71 = strlen(v235) + 1;
  CLog::Write((CGameGuard *)((char *)this + 32), "len: %d", v71 - 1);
  if ( (int)(v71 - 1 + 4) > 0 )
  {
    v72 = (unsigned __int8 *)Buffer;
    NumberOfBytesWritten = v71 - 1 + 4;
    do
    {
      v73 = *v72++;
      v70 += _wsprintfA(v70, "\\x%02x", v73);
...
LABEL_125:
  ...
  v75 = _Dect1(&`string');
  CLog::Write((CGameGuard *)((char *)this + 32), v75);
  v76 = (void *)*((_DWORD *)this + 1182);
  ExitCode = 0;
  Handles[0] = v76;
  ...
  {
    v80 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v80);
    v81 = ReadMemCrc(&ProcessInformation);
    v82 = (void (__stdcall *)(HANDLE))CloseHandle;
    v214 = v81;
    CloseHandle(ProcessInformation.hProcess);
    v82(ProcessInformation.hThread);
    CGameGuard::GetGameGuardDirectory(this, v236, 0x104u);
    strcat(v236, "\\");
    strcat(v236, (const char *)this + 4608);
    strcat(v236, _Dect1(&`string'));
    if ( !CFileAuthClient::Auth((CGameGuard *)((char *)this + 4532), v236, 1) )
    {
      v83 = GetLastError;
      GetLastError();
      v84 = *((_DWORD *)this + 1150);
      v201 = v83();
      v186 = v84;
      v85 = _Dect1(`string');
LABEL_107:
      CLog::Write((CLog *)v9, v85, v186, v201);
      return 120;
    }
    v86 = _Dect1(CONTAINER_NAME);
    if ( !CFileAuthClient::DecryptMem((CGameGuard *)((char *)this + 4532), v236, v238, 0x7FFu, v86 + 5) )
    {
      v87 = GetLastError;
      GetLastError();
      v88 = *((_DWORD *)this + 1150);
      v202 = v87();
      v89 = _Dect1(&`string');
      CLog::Write((CLog *)v9, v89, v88, v202);
      return 130;
    }
    v90 = _Dect(&`string');
    v169 = _Dect(&`string');
    v91 = _Dect1(&`string');
    MemGetPrivateProfileString(v90, v91, v169, (char *)Str1, 0x20u, v238);
    if ( _mbsicmp(Str1, (const unsigned __int8 *)this + 4608) )
    {
      v92 = _Dect1(&`string');
      CLog::Write((CGameGuard *)((char *)this + 32), v92);
      return 142;
    }
    v93 = _Dect1(&`string');
    nSendErlIni = MemGetPrivateProfileInt(v90, v93, 1, v238);
    v94 = _Dect1(&`string');
    g_dwWaitTime = MemGetPrivateProfileInt(v90, v94, 100000, v238);
    v95 = _Dect1(&`string');
    g_dwNoUpdate = MemGetPrivateProfileInt(v90, v95, 0, v238);
    v96 = _Dect1(&`string');
    NumberOfBytesWritten = MemGetPrivateProfileInt(v90, v96, 0, v238);
    v97 = _Dect1(&`string');
    Buffer = MemGetPrivateProfileInt(v90, v97, 0, v238);
    v98 = _Dect1(&`string');
    *((_BYTE *)this + 30) = (MemGetPrivateProfileInt(v90, v98, 0, v238) & 2) == 0;
    v99 = _Dect1(&`string');
    *((_DWORD *)this + 1179) = MemGetPrivateProfileInt(v90, v99, 1000, v238);
    v100 = _Dect1(&`string');
    *((_DWORD *)this + 1180) = MemGetPrivateProfileInt(v90, v100, 0, v238);
    memset(v238, 0, sizeof(v238));
    v101 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v101);
    CGameGuard::GetGameGuardDirectory(this, szGameMon, 0x104u);
    strcat(szGameMon, "\\");
    strcat(szGameMon, _Dect1(&`string'));
    if ( gg )
    {
      v203 = *((unsigned __int8 *)GetProcAddress + 4);
      v187 = *((unsigned __int8 *)GetProcAddress + 3);
      v177 = *((unsigned __int8 *)GetProcAddress + 2);
      v170 = *((unsigned __int8 *)GetProcAddress + 1);
      v163 = *(unsigned __int8 *)GetProcAddress;
      v102 = _Dect1(&`string');
      CLog::Write((CGameGuard *)((char *)gg + 32), v102, v163, v170, v177, v187, v203);
      if ( gg )
      {
        v204 = *((unsigned __int8 *)GetModuleHandleA + 4);
        v188 = *((unsigned __int8 *)GetModuleHandleA + 3);
        v178 = *((unsigned __int8 *)GetModuleHandleA + 2);
        v171 = *((unsigned __int8 *)GetModuleHandleA + 1);
        v164 = *(unsigned __int8 *)GetModuleHandleA;
        v103 = _Dect1(&`string');
        CLog::Write((CGameGuard *)((char *)gg + 32), v103, v164, v171, v178, v188, v204);
      }
    }
    v104 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v104);
    if ( _access(szGameMon, 0) == -1 )
    {
      ...
      {
        v105 = _Dect1(&`string');
        CLog::Write((CGameGuard *)((char *)this + 32), v105, szGameMon);
        return 154;
      }
    }
    if ( !CFileAuthClient::Auth((CGameGuard *)((char *)this + 4532), szGameMon, 1) )
    {
      v106 = GetLastError;
      GetLastError();
      v107 = *((_DWORD *)this + 1150);
      v189 = v106();
      v108 = _Dect1(&`string');
      CLog::Write((CLog *)v9, v108, v107, v189, szGameMon);
      return 122;
    }
    v109 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v109);
    if ( !CCommPipe::InitCommPipe((CGameGuard *)((char *)this + 4188)) )
    {
      v110 = _Dect1(&`string');
      CLog::Write((CGameGuard *)((char *)this + 32), v110);
      return 160;
    }
    v111 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v111);
    v112 = GetTickCount() & 0xFFF00000;
    if ( NumberOfBytesWritten < 0x2F )
    {
      v201 = 47;
      v186 = NumberOfBytesWritten;
      v85 = _Dect1(&`string');
      goto LABEL_107;
    }
    memset(&StartupInfo, 0, sizeof(StartupInfo));
    v113 = (void *)*((_DWORD *)this + 1182);
    ProcessInformation.hProcess = 0;
    ProcessInformation.hThread = 0;
    ProcessInformation.dwProcessId = 0;
    StartupInfo.cb = 68;
    ...
    ResetEvent(v113);
    v205 = Buffer;
    v190 = *((_DWORD *)this + 1182);
    v179 = *((_DWORD *)this + 1181);
    v165 = CCommPipe::GetChildWriteHandle((CGameGuard *)((char *)this + 4188));
    v158 = CCommPipe::GetChildReadHandle((CGameGuard *)((char *)this + 4188));
    v154 = *((unsigned __int8 *)this + 4713);
    v151 = *((_DWORD *)this + 1151);
    v114 = _Dect1(&`string');
    _wsprintfA(v235, v114, v112, v151, v154, v158, v165, (char *)this + 4608, v179, v190, v205);
    Buffer = (DWORD)_Enct(v235);
    v115 = CommandLine;
    v116 = strlen(v235) + 1;
    if ( (int)(v116 - 1 + 4) > 0 )
    {
      v117 = (unsigned __int8 *)Buffer;
      NumberOfBytesWritten = v116 - 1 + 4;
      do
      {
        v118 = *v117++;
        v115 += _wsprintfA(v115, "\\x%02x", v118);
        --NumberOfBytesWritten;
      }
      while ( NumberOfBytesWritten );
    }
    *v115 = 0;
    v119 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v119);
    if ( !dwDE )
      goto LABEL_122;
    if ( !CGameGuard::CheckGameMonSingleInstance(this, 0) )
    {
      v120 = _Dect1(&`string');
      v121 = OpenEventA(0x100000u, 0, v120);
      v122 = v121;
      if ( v121 )
      {
        if ( WaitForSingleObject(v121, 0) != 258 )
        {
          if ( !CGameGuard::CheckGameMonSingleInstance(this, 0x251Cu) )
            return 110;
          dwDE = 0;
    ...
    if ( dwDE )
    {
      v123 = strlen(CommandLine) + 1;
      v124 = *((_DWORD *)this + 1151);
      Filename[1] = 2027;
      Filename[2] = v124;
      NumberOfBytesWritten = (DWORD)v233;
      Filename[0] = v123 - 1 + 13;
      strcpy(v233, CommandLine);
      if ( !WriteSMMsg(Filename, v123 - 1 + 13) )
      {
        v125 = GetLastError;
        GetLastError();
        v185 = szGameMon;
        ...
        v126 = _Dect1(`string');
LABEL_126:
        CLog::Write((CGameGuard *)((char *)this + 32), v126, v176, v185, v235);
        return 170;
      }
    }
    else
...
LABEL_122:
      if ( !dwRE )
      {
        ...
        v206 = ProcessInformation.dwProcessId;
        v128 = _Dect1(&`string');
        CLog::Write((CGameGuard *)((char *)this + 32), v128, v206);
      }
    }
    bCheckGameMon = g_dwNoUpdate;
    if ( !g_dwNoUpdate )
    {
      LOBYTE(bCheckGameMon) = CheckGameMonCrc(szGameMon, &`string', v214);
      bCheckGameMon = (unsigned __int8)bCheckGameMon;
    }
    v129 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v129);
    v130 = CCommPipe::RunCommPipe((CGameGuard *)((char *)this + 4188));
    if ( !v130 )
    {
      v131 = GetLastError;
      GetLastError();
      v207 = v131();
      v132 = _Dect1(&`string');
      CLog::Write((CGameGuard *)((char *)this + 32), v132, v207);
      return 160;
    }
    v208 = v130;
    v133 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v133, v208);
    if ( dwDE )
    {
    ...
    else
    {
      ...
      {
        v134 = _Dect1(&`string');
        v135 = OpenEventA(0x100000u, 0, v134);
        if ( v135 )
        {
          CloseHandle(v135);
          if ( WaitForSingleObject(*((HANDLE *)this + 1181), g_dwWaitTime) )
          {
            ...
            v136 = _Dect1(`string');
LABEL_139:
            CLog::Write((CGameGuard *)((char *)this + 32), v136, v209);
            return 114;
          }
          goto LABEL_140;
        }
...
LABEL_140:
    ...
    v139 = _Dect1(&`string');
    v140 = OpenEventA(0x100000u, 0, v139);
    if ( v140 )
    {
      CloseHandle(v140);
      v141 = _Dect1(&`string');
      CLog::Write((CGameGuard *)((char *)this + 32), v141);
    }
    else
    {
    ...
    v142 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v142);
    if ( dwDE )
    {
      v143 = _Dect1(&`string');
    ...
    v145 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v145, v144);
    v146 = InitSocketAddr((int)this);
    if ( !v146 )
      CCommPipe::SendCommPipe((CGameGuard *)((char *)this + 4188), 0x8B1u, 0x630u, 0xDu);
    v147 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v147, v146);
    if ( *((_BYTE *)this + 30) && !CGameGuard::InitNPSC(this) )
    {
      v148 = _Dect1(&`string');
      CLog::Write((CGameGuard *)((char *)this + 32), v148);
      return 220;
    }
    v149 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v149);
    CCommPipe::SendCommPipe((CGameGuard *)((char *)this + 4188), 0x8B1u, 0x611u, *((_DWORD *)this + 1151));
    CCommPipe::SendCommPipe((CGameGuard *)((char *)this + 4188), 0x8B1u, 0x617u, v214);
    v150 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v150);
    *(_BYTE *)this = 1;
    return 1877;
  }
  if ( !GetExitCodeProcess(ProcessInformation.hProcess, &ExitCode) )
  {
    v199 = GetLastError();
    v77 = _Dect1(&`string');
    CLog::Write((CGameGuard *)((char *)this + 32), v77, v199);
  }
  v200 = ExitCode;
  v78 = _Dect1(&`string');
  CLog::Write((CGameGuard *)((char *)this + 32), v78, v200);
  v79 = (void (__stdcall *)(HANDLE))CloseHandle;
  CloseHandle(ProcessInformation.hProcess);
  v79(ProcessInformation.hThread);
  return ExitCode;
}
  ...
  *(_DWORD *)v63 = 0;
  ...
  if ( !RegCreateKeyExA(HKEY_CURRENT_USER, v4, 0, 0, 0, 0xF003Fu, 0, &phkResult, &dwDisposition) )
  {
    ...
    if ( dwDisposition == 2 )
    {
      ...
      v5(String2, "%hs", "Wed May  3 14:10:06 2006");
    ...
    v5((LPSTR)Data, "%hs", "Wed May  3 14:10:06 2006");
...
// 4F10: could not find valid save-restore pair for ebx
// 334: using guessed type int g_dwThreadId;
...
// 7518: using guessed type int __cdecl PPEncryptClientPacket(_DWORD, _DWORD, _DWORD);
...
// 751C: using guessed type int __cdecl PPDecryptServerPacket(_DWORD, _DWORD, _DWORD);
...
// 7520: using guessed type int __cdecl PPDecryptClientPacket(_DWORD, _DWORD, _DWORD);
...
// 61B8: using guessed type _SCOPETABLE_ENTRY _T63637;
...
// nfuncs=182 queued=70 decompiled=70 lumina nreq=0 worse=0 better=0
