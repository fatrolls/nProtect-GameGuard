...
char __thiscall CFileAuthClient::Decrypt(CFileAuthClient *this, LPCSTR lpFileName, LPCSTR a3, BYTE *pbData);
...
LABEL_61:
    if ( !a3
      || ((v19 = strrchr(lpFileName, 92)) == 0 ? (v20 = lpFileName) : (v20 = v19 + 1),
...
char __thiscall CFileAuthClient::Decrypt(CFileAuthClient *this, LPCSTR lpFileName, LPCSTR a3, BYTE *pbData)
{
  ...
  *((_DWORD *)this + 13) = v11[3];
  ...
  if ( !CryptDeriveKey(*(_DWORD *)this, 0x6801u, *v15, 0, (HCRYPTKEY *)this + 15) )
  {
    *((_DWORD *)this + 17) = 7;
    return 0;
  }
  ...
  if ( CryptDecrypt(*v16, 0, 1, 0, v17, (DWORD *)&lpFileName) )
    goto LABEL_35;
  ...
  {
LABEL_35:
    v18 = CreateFileA(a3, 0x40000000u, 3u, 0, 2u, 0x80u, 0);
    if ( v18 == (HANDLE)-1 )
    {
      *((_DWORD *)this + 17) = 9;
      result = 0;
    ...
    {
      WriteFile(v18, *((LPCVOID *)this + 1), *((_DWORD *)this + 2), (LPDWORD)&lpFileName, 0);
      SetEndOfFile(v18);
